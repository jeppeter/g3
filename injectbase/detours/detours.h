...
INJECTBASE_API LONG WINAPI DetourTransactionBegin();
INJECTBASE_API LONG WINAPI DetourTransactionAbort();
INJECTBASE_API LONG WINAPI DetourTransactionCommit();
...
INJECTBASE_API LONG WINAPI DetourDetach(PVOID *ppPointer,
                         PVOID pDetour);
INJECTBASE_API BOOL UpdateImports(HANDLE hProcess, LPCSTR *plpDlls, DWORD nDlls);
...
INJECTBASE_API int WINAPI DetourCreateProcessWithDllA(LPCSTR lpApplicationName,
...
INJECTBASE_API int WINAPI DetourCreateProcessWithDllW(LPCWSTR lpApplicationName,
